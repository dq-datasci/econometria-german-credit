...
3. **Capital/Condiciones:** `Age` (Edad), `Housing.Rent` (Falta de propiedad), `EmploymentDuration.gt.7` (Estabilidad laboral).
...
vars_numericas <- df_credito %>%
  select(Default, Amount, Duration, Age, InstallmentRatePercentage, NumberExistingCredits, ResidenceDuration)
